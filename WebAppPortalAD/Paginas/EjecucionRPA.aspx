<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EjecucionRPA.aspx.cs" Inherits="WebAppPortalAD.Paginas.EjecucionRPA" %>
...
<head>
    ...
    <script src="../Estilos/js/EjeRPA.js?v=1"></script>
                                ...
                                <div id="login-box" class="login-box visible widget-box no-border">
                                    <div class="widget-body">
                                        ...
                                        <div class="widget-main">
                                            <h4 class="header blue lighter bigger" style="text-align: center">Inciar ejecución de proceso
                                            </h4>
                                            <fieldset>
                                                ...
                                                <label class="block clearfix">
                                                    <span class="block input-icon input-icon-right">
                                                        <input type="text" class="form-control" placeholder="Id Ejecucion Proceso" id="idEjecucionProceso" />
                                                        <i class="ace-icon fa fa-file-text-o"></i>
                                                    </span>
                                                </label>
                                                ...
                                                <label class="block clearfix">
                                                    <span class="block input-icon input-icon-right">
                                                        <input type="text" class="form-control" placeholder="Id Proceso" id="idProceso" />
                                                        <i class="ace-icon fa fa-file-text-o"></i>
                                                    </span>
                                                </label>
                                                ...
                                                <label class="block clearfix">
                                                    <span class="block input-icon input-icon-right">
                                                        <input type="text" class="form-control" placeholder="Nombre Proceso" id="nombreProceso" />
                                                        <i class="ace-icon fa fa-file-text-o"></i>
                                                    </span>
                                                </label>
                                                ...
                                                <div class="form-group" id="ActualizarC" style="display: block">
                                                    ...
                                                    <div class="col-sm-9">               
                                                        <label>
                                                            <input id="switchfield1" name="switch-field-1" class="ace ace-switch" type="checkbox"/>
                                                            <span class="lbl"></span>
                                                        </label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="clearfix">
                                                    <button type="button" class="width-65 pull-right btn btn-sm btn-primary" id="btnRecuperar2" onclick="GuardarApiKey()" style="display: block">
