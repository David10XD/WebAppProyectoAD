<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="WebAppPortalAD.Paginas.Login" %>
...
<head>
    ...
    <link rel="icon" type="image/png" href="../Imagenes/ImagenesEmpresas/icono.png" sizes="16x16">
            ...
            <div class="row">
                <div class="col-sm-10 col-sm-offset-1">
                    <div class="login-container">
                        <div class="center">
                            <h1>
                                <span class="red3">Password Manager</span>
                                <%-- <span class="white" id="id-text2"></span>--%>
                            </h1>
                            <h4 class="white" id="id-company-text"><b>Auto servicio de credenciales</b></h4>
                        </div>
                                ...
                                <div id="login-box" class="login-box visible widget-box no-border">
                                    <div class="widget-body">
                                        ...
                                        <div class="widget-main">
                                            <h4 class="header blue lighter bigger" style="text-align: center">Iniciar sesión
                                            </h4>
                                            <%--                                            <div class="space-6"></div>--%>
                                            <fieldset>
                                                <label class="block clearfix">
                                                    <span class="block input-icon input-icon-right">
                                                        <input type="text" class="form-control" placeholder="Nombre de usuario" id="usuario" runat="server" />
                                                ...
                                                <label class="block clearfix">
                                                    <span class="block input-icon input-icon-right">
                                                        <input type="password" class="form-control" placeholder="Contraseña" id="clave" runat="server" />
                                        ...
                                        <div class="toolbar clearfix">
                                            <div>
                                                <a href="#" data-target="#forgot-box" class="forgot-password-link" onclick="CambiarContrasenia()">
                                                    <i class="ace-icon fa fa-arrow-left"></i>
                                                    Olvidé mi contraseña
                                                </a>
                                            </div>
                                            <div style="display: none">
                                                <a href="#" data-target="#signup-box" class="user-signup-link" onclick="BuscarUsuario()">Desbloquear usuario												
                                        ...
                                        <div>
                                            <div class="text-center">
                                                <p class="mt-5 mb-3 text-muted">© Producto <b>Password Manager</b> Desarrollado por Cloud Business & Solutions</p>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /.widget-body -->
                                            ...
                                            <fieldset>
                                                <div class="row" style="display: none" id="proceso1">
                                                    ...
                                                    <div class="clearfix">
                                                        ...
                                                        <%--<asp:Button ID="btnRecuperar" runat="server" Text="Aceptar" CssClass="width-35 pull-right btn btn-sm btn-primary" data-toggle="modal" data-target="#myModalRecuperar" OnClick="btnRecuperar_Click"></asp:Button>--%>
                                                    </div>
                                                    <br />
                                                    <ul>
