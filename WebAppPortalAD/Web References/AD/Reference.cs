...
namespace WebAppPortalAD.AD {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="BasicHttpBinding_ActualizarCuentaAD", Namespace="http://tempuri.org/")]
    public partial class ActualizarCuentaAD : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback ListaGruposOperationCompleted;
        
        private bool useDefaultCredentialsSetExplicitly;
        
        /// <remarks/>
        public ActualizarCuentaAD() {
            this.Url = global::WebAppPortalAD.Properties.Settings.Default.WebAppPortalAD_AD_ActualizarCuentaAD;
        ...
        /// <remarks/>
        public event ListaGruposCompletedEventHandler ListaGruposCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://172.16.0.102/ActualizarCuentaAD/ListaGrupos", RequestNamespace="http://172.16.0.102/", ResponseNamespace="http://172.16.0.102/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public string ListaGrupos() {
            object[] results = this.Invoke("ListaGrupos", new object[0]);
            return ((string)(results[0]));
        }
        
        /// <remarks/>
        public void ListaGruposAsync() {
            this.ListaGruposAsync(null);
        }
        
        /// <remarks/>
        public void ListaGruposAsync(object userState) {
            if ((this.ListaGruposOperationCompleted == null)) {
                this.ListaGruposOperationCompleted = new System.Threading.SendOrPostCallback(this.OnListaGruposOperationCompleted);
            }
            this.InvokeAsync("ListaGrupos", new object[0], this.ListaGruposOperationCompleted, userState);
        }
        
        private void OnListaGruposOperationCompleted(object arg) {
            if ((this.ListaGruposCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.ListaGruposCompleted(this, new ListaGruposCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.4084.0")]
    public delegate void ListaGruposCompletedEventHandler(object sender, ListaGruposCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.4084.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class ListaGruposCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal ListaGruposCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
